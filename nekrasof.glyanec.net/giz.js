(function ($) {
	...
	$(document).ready(function() {
		...
		$('.view-reviews.view-display-id-block_5 .view-content').slick({
			infinite: true,
			slidesToShow: 4,
			slidesToScroll: 1
		})
		$('.view-reviews.view-display-id-block_4 .view-content,.view-reviews.view-display-id-block_1 .view-content,.view-reviews.view-display-id-block_2 .view-content').slick({
			infinite: true,
			slidesToShow: 4,
			slidesToScroll: 1,
			responsive: [
